/**
 * Tooltip compartido para la capa de gráficos (consumido por TrendArea,
 * CompareBars y DonutChart). Muestra siempre el valor absoluto y, junto a él,
 * la participación porcentual dentro del punto que se está mirando.
 */
