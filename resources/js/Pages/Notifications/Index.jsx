...
export default function Index({ notifications }) {
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8">
                {/* Header */}
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                    <div className="flex items-center gap-3">
                        <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#045474] to-[#1c486c] flex items-center justify-center text-white shadow-lg shadow-[#045474]/20 shrink-0">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-start justify-between gap-3">
                                                                ...
                                                                <div className="flex items-center gap-2 shrink-0">
                                                                    ...
                                                                    <span className="text-xs text-gray-400 tabular-nums">{timeAgo(n.created_at)}</span>
                                                                </div>
                                                            </div>
                                                            {n.body && (
                                                            ...
                                                            {n.lead && (
                                                                <Link
                                                                    ...
                                                                    className="mt-2 inline-flex items-center gap-1 text-xs font-semibold text-[#045474] hover:text-emerald-700 transition-colors"
                                                                >
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            <div className="p-12 sm:p-16 text-center">
                                ...
                                <p className="text-sm text-gray-500 mt-1 max-w-xs mx-auto">
                                    Te avisaremos de leads asignados, nuevos leads por WhatsApp o formulario, y tareas vencidas.
                                </p>
                            </div>
                        </div>
                    )}
