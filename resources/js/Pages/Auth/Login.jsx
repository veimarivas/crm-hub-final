                    ...
                    <div className="p-8 sm:p-10">
                        ...
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full py-2.5 px-4 bg-gradient-to-r from-[#042048] to-[#045474] text-white text-sm font-medium rounded-lg hover:from-[#1c486c] hover:to-[#045474] focus:outline-none focus:ring-2 focus:ring-[#045474] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-[#042048]/25"
                            >
