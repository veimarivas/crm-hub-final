...
const navigation = [
    ...
    },
    {
        ...
        // Va en CONFIGURACIÓN: es un catálogo que se mantiene, no una
        // pantalla de trabajo diario. El agente sigue pudiendo asociar una
        // empresa desde la ficha del lead (el desplegable no usa esta ruta).
        adminOnly: true,
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
        // Va en CONFIGURACIÓN y no en el area de trabajo: configurar algo que
        // le escribe solo a los clientes no es tarea diaria del asesor.
        name: 'Workflows',
        pattern: 'workflows.*',
        routeName: 'workflows.index',
        adminOnly: true,
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
        name: 'Pipelines',
        pattern: 'settings.pipelines*',
        routeName: 'settings.pipelines',
        adminOnly: true,
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
        name: 'Horario',
        pattern: 'settings.business-hours*',
        routeName: 'settings.business-hours',
        adminOnly: true,
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
