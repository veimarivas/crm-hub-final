 ...
 * duplicado en este repo y en el wacrm sin ninguna razón para ser dos. La
...
class SharedFilesDriftTest extends TestCase
{
    ...
    private const TWIN_DIRNAME = 'laravel_crm_whatsapp';
    ...
    public function test_los_archivos_compartidos_siguen_siendo_identicos(): void
    {
        ...
        if ($twin === null) {
            $this->markTestSkipped(
                ...
                .'apuntá TWIN_REPO_PATH a la carpeta del wacrm.'
            );
        }
